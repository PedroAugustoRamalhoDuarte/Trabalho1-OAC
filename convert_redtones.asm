...
.text	
	...
	#-------------------------------------------------------------------------
	# Funcao convert_redtones: Recebe de parametro o endereço de inicio de uma imagem
	# aplica uma máscara que zera todos os bits que não possuem a informação do vermelho
	#
	# A função foi implementada da seguinte maneira:
	# 1 - Coloca o ponteiro no endereço do inicio da imagem
	# 2 - Carrega o valor da word
	...
	convert_redtones:
		...
		blez 	s8, cabouImagem			# se a quantidade de repetições = 0, encerramos a execução
